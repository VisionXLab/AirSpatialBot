...
if __name__ == "__main__":
    ...
    print(f"ALL:")
    print(f'3D Precision @ 0.25: {correct / total_cnt_true} \n')
    print(f'BEV Precision @ 0.25: {bev_correct / total_cnt_true} \n')
    print(f'Format error ratio: {format_error / total_cnt_true} \n')
